...
2. [Заполнение значений](#in-fill-in) из вкладки "IN" и отправка их к сервису BetEngines. В ответ BetEngines отправит рассчитанные значения из вкладки "OUT". Этот шаг повторяется до окончания события.
...
Производит расчет значений во вкладке "OUT" по переданным значением IN вкладки. Возвращает рассчитанные значения вкладки "OUT".
